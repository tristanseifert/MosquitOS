...
// Creates a VGA colour attribute entry for the specific colours
#define vga_make_colour(fg, bg) fg | bg << 4

void vga_set_text_mode(bool hi_res);
void vga_write_font(uint8_t *buf, uint8_t font_height);

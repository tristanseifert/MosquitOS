...
qemu-1.60/qemu-system-i386 -hda /Users/tristanseifert/SquelchenOS/disk_image.img -m 256M -soundhw ac97 -net nic,model=e1000 -net user -device sysbus-ohci -device usb-ehci -device vmware-svga -s
